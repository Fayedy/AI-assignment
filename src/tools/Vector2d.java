...
//        h = 2 * h;
    ...
    /**
     * Returns the Manhattan distance from this vector to the one in the arguments.
     * @param v the other vector, to calculate the distance to.
     * @return the Manhattan distance, in pixels, between this vector and v.
     */
    public double mdist(Vector2d v) {
